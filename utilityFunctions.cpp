...
void scaleViews(sf::RenderWindow *window, sf::View *mainView, Dialogue *dialogue, HUD *hud, BattleStats *battleStats){
	...
	if(ratioX < ratioY){
		...
		dialogue->setViewport(sf::FloatRect(0.0,1.0-DIALOGUE_VIEWPORT_RELATIVE_HEIGHT*newRatioY-(1-newRatioY)*0.5f,1.0,DIALOGUE_VIEWPORT_RELATIVE_HEIGHT*newRatioY));
		...
		dialogue->setViewport(sf::FloatRect((1-newRatioX)*0.5f,1.0-DIALOGUE_VIEWPORT_RELATIVE_HEIGHT,newRatioX,DIALOGUE_VIEWPORT_RELATIVE_HEIGHT)); // this draws from top left
